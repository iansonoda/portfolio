        ...
        <div className="flex flex-col flex-1 space-y-6 text-center md:text-left">
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 pt-4">
            ...
            {personal.contact.linkedin && (
              <a href={personal.contact.linkedin} target="_blank" rel="noreferrer" className="flex items-center gap-2 text-sm font-medium text-foreground bg-muted/50 hover:bg-muted px-4 py-2.5 rounded-lg transition-colors border border-border/50 shadow-sm hover:shadow">
                <svg fill="currentColor" viewBox="0 0 24 24" className="w-4 h-4">
            ...
            {personal.contact.email && (
              <a href={`mailto:${personal.contact.email}`} className="flex items-center gap-2 text-sm font-medium text-foreground bg-muted/50 hover:bg-muted px-4 py-2.5 rounded-lg transition-colors border border-border/50 shadow-sm hover:shadow">
                <svg fill="currentColor" viewBox="0 0 24 24" className="w-4 h-4">
